...
## About Me
- I'm Senior Full-Stack & Mobile Developer (`PHP`, `Symfony`, `Vanilla JS`, `React`, `NextJS` `Redux`, `React Native`, `Expo`, `Typescript`) for +8 years spent in developing web and mobile solutions. <br/>
